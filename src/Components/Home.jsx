    ...
    <>
      <section className="relative w-full h-screen" id="home">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center px-4">
          ...
          <p className="text-white text-base sm:text-lg md:text-xl mt-6 max-w-2xl sm:max-w-3xl mx-auto opacity-90">
          ...
          <button  className="mt-8 bg-red-500 hover:bg-red-600 text-white px-6 sm:px-8 py-3 rounded-md text-base sm:text-lg font-semibold shadow-lg transition duration-300">
            Donate Now
          </button>
        </div>
      </section>
